    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.automation");
                servletContext.setInitParameter("tapestry.development-modules", "org.automation.services.DevelopmentModule");
